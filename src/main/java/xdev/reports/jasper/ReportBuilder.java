...
public class ReportBuilder
{
	...
	/**
	 * Create an {@link ExporterInput} from Parameters
	 * @return {@link ParametersExporterInput}
	 * @throws JRException
	 */
	private ParametersExporterInput createExporterInput() throws JRException
	{
		this.parameters.put(JRExporterParameter.JASPER_PRINT, this.getJasperPrint());
	...
	public void writePdfFile(final OutputStream out) throws JRException
	{
		...
		final ParametersExporterInput exporterInput = this.createExporterInput();
