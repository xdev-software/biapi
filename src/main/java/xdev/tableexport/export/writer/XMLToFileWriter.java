 ...
 * 
 * <p>
 * The generated XML content is placed into a {@code File}.
 * </p>
 * 
 * @author XDEV Software(FHAE)
 */
@SuppressWarnings("deprecation")
public class XMLToFileWriter implements ExportWriter
{
	...
	/**
	 * Constructs a {@link XMLToFileWriter} object given a {@link File} object.
	 * 
	 * @param file a {@link File} object to write to.
	 */
	public XMLToFileWriter(final File file)
	{
		this.file = file;
	}	
