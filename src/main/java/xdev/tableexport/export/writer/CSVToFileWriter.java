 ...
 * 
 * <p>
 * The generated CSV content is placed into a {@code File}.
 * </p>
 * 
 * @author XDEV Software(FHAE)
 */
@SuppressWarnings("deprecation")
public class CSVToFileWriter implements ExportWriter
{
	...
	/**
	 * Constructs a {@link CSVToFileWriter} object given a {@link File} object.
	 * 
	 * @param file a {@link File} object to write to.
	 */
	public CSVToFileWriter(final File file)
	{
		this.file = file;
	}	
