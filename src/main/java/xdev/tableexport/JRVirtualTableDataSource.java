...
import xdev.reports.jasper.AbstractVirtualTableDataSource;
	...
	public Object getFieldValue(@NotNull final JRField jrField) throws JRException
	{
		try
		{
			...
			switch(column.getType())
			{
				...
				case CLOB:
					final XdevClob xClob = ((XdevClob)this.virtualTable.getValueAt(this.currentRowIndex,jrField.getName()));
